...
import AddLedgerEntryForm from "./AddLedgerEntryFormVillage";
import {
  Card,
  CardContent,
  CardHeader,
...
const VillageLedgerDebitCredit: React.FC<Props> = ({
  selectedDate,
  onBack,
}) => {
  ...
  const t = {
    title: { en: "Village Ledger", bn: "গ্রাম খতিয়ান" },
...
export default VillageLedgerDebitCredit;
